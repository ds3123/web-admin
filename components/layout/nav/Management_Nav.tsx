...
const Management_Nav : FC = () => {
    ...
    return <div className = "flex" >
              ...
              <Link href = '/management/setting' >  <p className = { `nav_btn ${ action === 'setting' ? 'bg-blue-400 text-white' : ''  }` } > 分類設定 </p> </Link>
              <Link href = '/management/price' >    <p className = { `nav_btn ${ action === 'price'   ? 'bg-blue-400 text-white' : ''  }` } > 價格設定 </p> </Link>
